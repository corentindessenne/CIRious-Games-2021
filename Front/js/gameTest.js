(function() {
    ...
    let player1 = new player(0, "Armand", 190, 20, img1);
    let player2 = new player(1, "Marie", 181, 18, img2);
    let player3 = new player(2, "Corentin", 176, 19, img3);
    let player4 = new player(3, "Adel", 175, 20, img4);
    let player5 = new player(4, "Noé", 186, 19, img5);
    let player6 = new player(5, "Antoine", 177, 20, img6);
